...
export const CARE_PACKAGES: CarePackage[] = [
  {
    ...
    scope: [
      { category: 'Activities of Daily Living (ADLs)', detail: 'Light help with bathing, dressing, grooming' },
      ...
      { category: 'Companionship & Social Support', detail: 'Conversation and light activities' },
      { category: 'Family Communication', detail: 'Daily care log updates' },
      { category: 'Post-Hospital / Recovery Care', detail: 'Light recovery help' },
  ...
  },
  {
    ...
    scope: [
      { category: 'Activities of Daily Living (ADLs)', detail: 'Full ADL help incl. toileting and mobility' },
      ...
      { category: 'Companionship & Social Support', detail: 'Companionship + emotional reassurance' },
      { category: 'Family Communication', detail: 'Daily log + quick phone/WhatsApp updates' },
      { category: 'Post-Hospital / Recovery Care', detail: 'Structured post-discharge routine' },
  ...
  },
  {
    ...
    scope: [
      { category: 'Activities of Daily Living (ADLs)', detail: 'Full ADL + assisted transfers and repositioning' },
      ...
      { category: 'Companionship & Social Support', detail: 'Ongoing companionship and engagement' },
      { category: 'Family Communication', detail: 'Daily log + weekly supervisor call' },
      { category: 'Post-Hospital / Recovery Care', detail: 'Intensive mobility and ADL support' },
      { category: 'Palliative / Comfort Support', detail: 'Comfort routines and presence' },
  ...
  },
  {
    ...
    bestFor: [
      'Bedridden adults with long-term illness (cancer, neurological disorders) not needing invasive nursing',
      'Non-clinical palliative comfort care',
      'Post-ICU discharge adults requiring total daily support but no medical procedures',
    ],
    highlights: [
    ...
    scope: [
      { category: 'Activities of Daily Living (ADLs)', detail: 'Complete ADL and bedside hygiene' },
      ...
      { category: 'Companionship & Social Support', detail: 'Comfort presence and emotional support' },
      { category: 'Family Communication', detail: 'Daily logs + frequent family updates and escalation plan' },
      { category: 'Post-Hospital / Recovery Care', detail: 'Full long-term comfort care' },
      { category: 'Palliative / Comfort Support', detail: 'Dedicated bedside palliative presence' },
